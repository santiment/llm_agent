...
|---|---|---|---|---|---|
| `extra-low` | `deepseek/deepseek-v4-flash-0731` (0.07/0.18) | `deepseek/deepseek-v4-flash-0731` (0.07/0.18) | `deepseek/deepseek-v4-flash-0731` | `deepseek/deepseek-v4-flash-0731` | `deepseek/deepseek-v4.1-flash` (0.15/0.60) |
| `low` | `deepseek/deepseek-v4.1-flash` (0.15/0.60) | `deepseek/deepseek-v4-flash-0731` (0.07/0.18) | `deepseek/deepseek-v4-flash-0731` | `openai/gpt-5.6-luna` (0.20/1.20) | `openai/gpt-5.6-luna` |
| `mid` | `google/gemini-3.8-flash` (0.75/3.75) | `deepseek/deepseek-v4.1-flash` (0.15/0.60) | `deepseek/deepseek-v4-flash-0731` | `openai/gpt-5.6-luna` | `google/gemini-3.8-flash` |
